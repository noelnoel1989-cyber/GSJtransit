...
async function fetchBusData() {
  ...
  try {
    ...
    if (!data.Siri.ServiceDelivery) {
      console.log("No ServiceDelivery");
      return results;
    }

    if (!data.Siri.ServiceDelivery.StopMonitoringDelivery) {
    ...
    for (let d = 0; d < deliveries.length; d++) {
      ...
      console.log("Visit count for delivery", d, ":", visits.length);
